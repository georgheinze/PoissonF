...
names(col_all) <- c("ML", "FL", "FLAC",  "XP", "XP:mid-p", "BDA", "LXPMLE", "LXPMLE_1", "LXPMLE_2")
...
PoissonFResultsTable$method[PoissonFResultsTable$method=="Exact"] <- "XP"
PoissonFResultsTable$method[PoissonFResultsTable$method=="Mid-P"] <- "XP:mid-p"
PoissonFResultsTable$method[PoissonFResultsTable$method=="DatAug"] <- "BDA"
PoissonF_sep_nonconv$method[PoissonF_sep_nonconv$method=="Exact"] <- "XP"

show_tab<-function(methods=c("ML", "FLAC", "LXPMLE", "BDA", "XP"), stat="bias1", multi=1, rounder=10, log=FALSE, dattable=PoissonFResultsTable){
...
XL_tab1 <-show_tab(methods="XP", stat="BetaNA1", multi=100, round=1, dattable=PoissonF_sep_nonconv) 
XL_tab2 <-show_tab(methods="XP", stat="BetaNA2", multi=100, round=1, dattable=PoissonF_sep_nonconv) 
MUE_tab1 <-show_tab(methods="XP", stat="MUE1", multi=100, round=1, dattable=PoissonF_sep_nonconv) 
MUE_tab2 <-show_tab(methods="XP", stat="MUE2", multi=100, round=1, dattable=PoissonF_sep_nonconv) 

XL_tab <- cbind(XL_tab1[,1:4], Beta1_na=XL_tab1[,5], Beta2_na=XL_tab2[,5],
                   Beta1_MUE=MUE_tab1[,5], Beta2_MUE=MUE_tab2[,5])


RMSPEN_tab<-show_tab(methods=c("ML","FL","FLAC","BDA"), stat="rmspen", multi=100, round=0)

BIAS1_tab<-show_tab(methods=c("ML", "FLAC", "LXPMLE", "BDA", "XP"), stat="bias1", multi=100, round=0)

BIAS2_tab<-show_tab(methods=c("ML", "FLAC", "LXPMLE", "BDA", "XP"), stat="bias2", multi=100, round=0)

RMSE1_tab <- show_tab(methods=c("ML", "FLAC", "LXPMLE", "BDA", "XP"), stat="rmsen1", multi=100, round=0)

RMSE2_tab <- show_tab(methods=c("ML", "FLAC", "LXPMLE", "BDA", "XP"), stat="rmsen2", multi=100, round=0)

leftcov1_tab<-show_tab(methods=c("ML","FLAC","LXPMLE","BDA","XP","XP:mid-p"), stat="leftcov1", multi=1000, round=0)
leftcov2_tab<-show_tab(methods=c("ML","FLAC","LXPMLE","BDA","XP","XP:mid-p"), stat="leftcov2", multi=1000, round=0)
rightcov1_tab<-show_tab(methods=c("ML","FLAC","LXPMLE","BDA","XP","XP:mid-p"), stat="rightcov1", multi=1000, round=0)
rightcov2_tab<-show_tab(methods=c("ML","FLAC","LXPMLE","BDA","XP","XP:mid-p"), stat="rightcov2", multi=1000, round=0)
...
power1_tab<-show_tab(methods=c("ML","FLAC","LXPMLE","BDA","XP","XP:mid-p"), stat="power1", multi=100, round=0)
power2_tab<-show_tab(methods=c("ML","FLAC","LXPMLE","BDA","XP","XP:mid-p"), stat="power2", multi=100, round=0)

width1_tab<-show_tab(methods=c("ML","FLAC","LXPMLE","BDA","XP","XP:mid-p"), stat="width1", multi=100, round=0)
width2_tab<-show_tab(methods=c("ML","FLAC","LXPMLE","BDA","XP","XP:mid-p"), stat="width2", multi=100, round=0)
...
|Data augmentation (BDA)|Yes|Profile penalized likelihood|Yes|macro %dataugpoisson|
|XP|Yes|Exact|No|PROC LOGXACT|
|XP:mid-p|(same as XP)|XP:mid-p|No|PROC LOGXACT|
...
#### Unavailability of XP estimates

This table shows by scenario the percentage of data sets with XP estimates being totally unavailable, and of median unbiased estimates (MUE) replacing the maximum likelihood estimate.
...
MUE_tab1.plot <-show_tab(methods="XP", stat="MUE1", multi=100, dattable=PoissonF_sep_nonconv) 
...
p.sep <- nested_loop_plot(resdf = sep_tab.plot,
                          ...
                          x_name = TeX("$\\beta_1$"),
                          legend_labels = c("ML estimate does not exist", "MCLE replaced by MUE"),
                          design_type = "partial",
...
```{r}
if(params$save.plot) {
  ggsave("sep.tiff", plot = p.sep, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
if(params$save.plot) {
  ggsave("lxpmle1.tiff", plot = p.lxpmle1, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
if(params$save.plot) {
  ggsave("lxpmle2.tiff", plot = p.lxpmle2, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
kable(RMSPEN_tab)
# for description;
# tmp <- show_tab(methods=c("ML","FL","FLAC","BDA"), stat="rmspen", multi=100, round=5)
# cbind(tmp[,1:4], t(apply(tmp[,c("ML","FL","FLAC","BDA")], 1, function(x) c("ML", "FL","FLAC", "BDA")[order(x)] )) )
# rm(tmp)
```

```{r rmspen.plot}
RMSPEN_tab<-show_tab(methods=c("ML","FL","FLAC","BDA"), stat="rmspen", multi=1) %>% data.frame()
names(RMSPEN_tab)[names(RMSPEN_tab)=="ncov"] <- "k"


col <- col_all[c("ML","FL","FLAC","BDA")]
...
```{r}
if(params$save.plot) {
  ggsave("Figure1.tiff", plot = p.predacc, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
BIAS1_tab<-show_tab(methods=c("ML", "FL", "LXPMLE", "XP", "BDA"), stat="bias1", multi=1)
...
```{r}
if(params$save.plot) {
  ggsave("bias1_main.tiff", plot = p.bias1, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
if(params$save.plot) {
  ggsave("bias1_extra.tiff", plot = p.bias1.extra, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
BIAS2_tab<-show_tab(methods=c("ML", "FL", "LXPMLE", "BDA", "XP"), stat="bias2", multi=1) %>% data.frame()
...
```{r}
if(params$save.plot) {
  ggsave("bias2_main.tiff", plot = p.bias2, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
if(params$save.plot) {
  ggsave("bias2_extra.tiff", plot = p.bias2.extra, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
RMSE1_tab <- show_tab(methods=c("ML", "FL", "LXPMLE", "XP", "BDA"), stat="rmsen1", multi=1)
...
```{r}
if(params$save.plot) {
  ggsave("rmse1.tiff", plot = p.rmse1, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
if(params$save.plot) {
  ggsave("rmse1_extra.tiff", plot = p.rmse1.extra, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
RMSE2_tab <- show_tab(methods=c("ML", "FL", "LXPMLE", "XP", "BDA"), stat="rmsen2", multi=1)
...
```{r}
if(params$save.plot) {
  ggsave("rmse2.tiff", plot = p.rmse1, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
if(params$save.plot) {
  ggsave("rmse2_extra.tiff", plot = p.rmse2.extra, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
leftcov1_tab<-show_tab(methods=c("ML","FL","XP","XP:mid-p","BDA"), stat="leftcov1") %>% data.frame() %>% 
  mutate(ML = ifelse(ML < 0.90, NA, ML))
leftcov1_tab %<>% mutate(across(c(ML, FL, BDA,XP,XP.mid.p), ~mirror(.x)))
rightcov1_tab<-show_tab(methods=c("ML","FL","XP","XP:mid-p","BDA"), stat="rightcov1") %>% data.frame() %>% 
  mutate(ML = ifelse(ML < 0.90, NA, ML))
...
col <- col_all[c("ML","FL","XP","XP:mid-p","BDA")]
col <- col[sort(names(col))]
p.coverage1 <- nested_loop_plot(
    cov1.plot, x = "beta1", grid_rows = "k", steps = "n", 
    colors = col,
    #replace_labels = labs,
    legend_breaks = c("left_ML", "left_FL", "left_XP", "left_XP.mid.p", "left_BDA"),
    legend_labels = c("ML", "FL", "XP", "XP:mid-p", "BDA"),
...
```{r}
if(params$save.plot) {
  ggsave("Figure3.tiff", plot = p.coverage1, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
if(params$save.plot) {
  ggsave("coverage1_extra.tiff", plot = p.coverage1.extra, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
leftcov2_tab<-show_tab(methods=c("ML","FL","XP","XP:mid-p","BDA"), stat="leftcov2") %>% data.frame() %>% 
  mutate(ML = ifelse(ML < 0.90, NA, ML))
leftcov2_tab %<>% mutate(across(c(ML, FL, BDA,XP,XP.mid.p), ~mirror(.x)))
rightcov2_tab<-show_tab(methods=c("ML","FL","XP","XP:mid-p","BDA"), stat="rightcov2") %>% data.frame() %>% 
  mutate(ML = ifelse(ML < 0.90, NA, ML))
...
```{r}
if(params$save.plot) {
  ggsave("coverage2.tiff", plot = p.coverage2, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
if(params$save.plot) {
  ggsave("coverage2_extra.tiff", plot = p.coverage2.extra, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
power1_tab<-show_tab(methods=c("ML","FL","XP","XP:mid-p","BDA"), stat="power1", multi=100)  %>% data.frame() %>% select(-epv)
...
p.power1 <- nested_loop_plot(
    ...
    colors = col,
    #replace_labels = labs,
    legend_breaks = c("ML", "FL", "XP", "XP.mid.p", "BDA"),
    legend_labels = c("ML", "FL", "XP", "XP:mid-p", "BDA"),
    steps_y_base = -15,
    steps_y_height = 4, 
    steps_values_annotate = TRUE, 
...
```{r}
if(params$save.plot) {
  ggsave("power1.tiff", plot = p.power1, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
if(params$save.plot) {
  ggsave("power1_extra.tiff", plot = p.power1.extra, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
power2_tab<-show_tab(methods=c("ML", "FL", "XP", "XP:mid-p", "BDA"), stat="power2", multi=100)  %>% data.frame() %>% select(-epv)
...
```{r}
if(params$save.plot) {
  ggsave("power2.tiff", plot = p.power2, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
if(params$save.plot) {
  ggsave("power2_extra.tiff", plot = p.power2.extra, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
width1_tab<-show_tab(methods=c("ML","FL","XP","XP:mid-p","BDA"), stat="width1", multi=1)
width1.plot <- merge(width1_tab, PoissonF_sep_nonconv %>% select(MUE1,n,ncov,truebeta1) %>% mutate(beta1=round(truebeta1,2)) %>% data.frame() %>% filter(!is.na(MUE1)), all.x=T) %>% data.frame() %>%
  mutate(XP = ifelse((MUE1 < 0.5 | is.na(MUE1)), XP, NA), 
         XP.mid.p = ifelse((MUE1 <0.5 | is.na(MUE1)), XP.mid.p, NA),
...
```{r}
if(params$save.plot) {
  ggsave("width1.tiff", plot = p.width1, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
if(params$save.plot) {
  ggsave("width1_extra.tiff", plot = p.width1.extra, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
width2_tab<-show_tab(methods=c("ML","FL","XP","XP:mid-p","BDA"), stat="width2", multi=1) %>% data.frame() %>% select(-epv)
...
```{r}
if(params$save.plot) {
  ggsave("width2.tiff", plot = p.width2, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
...
```{r}
if(params$save.plot) {
  ggsave("width2_extra.tiff", plot = p.width2.extra, width=7, height=7,dpi = 600, compression ="lzw")
} 
```
