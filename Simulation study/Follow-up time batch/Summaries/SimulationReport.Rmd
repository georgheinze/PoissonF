...
```{r}
library(readr)
PoissonFResultsTable <- read_delim("~/1Projects/2018-08 NegBinom FC/Github/PoissonF/Simulation study/Follow-up time batch/Summaries/PoissonFResultsTable.csv", 
    ";", escape_double = FALSE, trim_ws = TRUE)
PoissonF_sep_nonconv <- read_delim("~/1Projects/2018-08 NegBinom FC/Github/PoissonF/Simulation study/Follow-up time batch/Summaries/PoissonF_sep_nonconv.csv", 
    ";", escape_double = FALSE, trim_ws = TRUE)
```
