...
p.coverage1 <- nested_loop_plot(
    cov1.plot, x = "beta1", grid_rows = "ncov", steps = "n", 
    colors = col[1:5],
    replace_labels = labs,
...
p.coverage2 <- nested_loop_plot(
    cov2.plot, x = "beta1", grid_rows = "ncov", steps = "n", 
    colors = col[1:5],
    replace_labels = labs,
    legend_breaks = c("left_ML", "left_Firth", "left_DatAug", "left_Exact", "left_Mid.P"),
    legend_labels = c("ML", "FL", "DAP", "XL", "Mid-P"),
...
p.power1 <- nested_loop_plot(
    power1_tab, x = "beta1", grid_rows = "ncov", steps = "n", 
    colors = col,
    replace_labels = labs,
    steps_y_base = -15,
    steps_y_height = 4, 
...
p.power2 <- nested_loop_plot(
    power2_tab, x = "beta1", grid_rows = "ncov", steps = "n", 
    colors = col,
    replace_labels = labs,
    steps_y_base = -15,
    steps_y_height = 4, 
...
p.width1 <- nested_loop_plot(
    width1.plot, x = "beta1", grid_rows = "ncov", steps = "n", 
    colors = col,
    replace_labels = labs,
    steps_y_base = -100,
    steps_y_height = 20, 
...
p.width1.extra <- nested_loop_plot(
    width1_tab, x = "beta1", grid_rows = "ncov", steps = "n", 
    colors = col,
    replace_labels = labs,
    steps_y_base = -100,
    steps_y_height = 10, 
...
p.width2 <- nested_loop_plot(
    width2_tab, x = "beta1", grid_rows = "ncov", steps = "n", 
    colors = col,
    replace_labels = labs,
    steps_y_base = -50,
    steps_y_height = 10, 
